...
device_id = int(raw_input("Choose device [" + str(default_device_index) + "]: ") or default_device_index)
print ""
...
recordtime = int(raw_input("Record time in seconds [" + str(recordtime) +"]: ") or recordtime)
...
filename = raw_input("Save as ["  + "out.wav" + "]: ") or "out.wav"
